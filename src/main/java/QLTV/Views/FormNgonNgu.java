 ...
 * @author Admin
 */
public class FormNgonNgu extends JPanel {
    private JTextField txtSearch = new JTextField();
    private JButton btnSearch = new JButton("Tìm");

    private JTextField txtMaNN = new JTextField();
    private JTextField txtTenNN = new JTextField();
    ...
    private JComponent createHeader() {
        ...
        JLabel title = new JLabel("QUẢN LÝ NGÔN NGỮ");
    ...
    private JComponent createFormCard() {
        ...
        JLabel lb = new JLabel("Thông tin ngôn ngữ");
        ...
        int r = 0;
        r = addRow(form, gbc, r, "Mã ngôn ngữ", txtMaNN);
        r = addRow(form, gbc, r, "Tên ngôn ngữ", txtTenNN);
        ...
        txtMaNN.setBackground(new Color(230, 230, 230));
    ...
    private JComponent createTableCard() {
        ...
        JLabel lb = new JLabel("Danh sách ngôn ngữ");
        lb.setFont(new Font("Segoe UI", Font.BOLD, 16));
        lb.setForeground(new Color(30, 50, 90));

        String[] cols = {"Mã ngôn ngữ", "Tên ngôn ngữ"};
        model = new DefaultTableModel(cols, 0) {
            @Override public boolean isCellEditable(int row, int col) { return false; }
        };

        tblNN = new JTable(model);
        tblNN.setRowHeight(28);
        tblNN.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        tblNN.getTableHeader().setFont(new Font("Segoe UI", Font.BOLD, 13));
        tblNN.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);

        JScrollPane sp = new JScrollPane(tblNN);
    ...
    public JTable getTblNN() { return tblNN; }
    public DefaultTableModel getModel() { return model; }

    public String getMaNN() { return txtMaNN.getText().trim(); }
    public String getTenNN() { return txtTenNN.getText().trim(); }

    public void setMaNN(String ma) { txtMaNN.setText(ma); }
